...
export function resolveBinary(name, override = process.env[`OVERLEAF_EDIT_${name.toUpperCase()}_BIN`]) {
...
export const MAX_FULLTEXT_CHARS = Number(process.env.OVERLEAF_EDIT_MAX_CHARS || 120000);
